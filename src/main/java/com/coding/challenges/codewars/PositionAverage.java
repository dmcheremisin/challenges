...
public class PositionAverage {
    ...
    public static void main(String[] args) {
        double average = posAverage("466960, 069060, 494940, 060069, 060090, 640009, 496464, 606900, 004000, 944096");
    ...
    public static double posAverage(String s) {
        ...
        int allLength = strings[0].length() * combinations;
        return  100 * matches / (double) allLength;
    }
}