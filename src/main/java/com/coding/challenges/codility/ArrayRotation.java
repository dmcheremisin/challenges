...
// index, and the last element of the array is moved to the first place. For example, the rotation of array A = [3,
// 8, 9, 7, 6] is [6, 3, 8, 9, 7] (elements are shifted right by one index and 6 is moved to the first place).
//
...
public class ArrayRotation {
    ...
    public static void main(String[] args) {
        ...
        printArr(arrayRotation.solution(new int[]{3, 8, 9, 7, 6}, 3));
    }
